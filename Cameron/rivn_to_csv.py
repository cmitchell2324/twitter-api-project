...
search_term = 'rivn -filter:retweets'      # Seach query. Disregards retweets.
file_name = 'rivn_tweets.csv'  # Name of the csv file the dataframe of tweets will be written to.
