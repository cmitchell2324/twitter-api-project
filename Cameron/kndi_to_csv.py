...
search_term = 'kndi -filter:retweets'      # Seach query. Disregards retweets.
file_name = 'kndi_tweets.csv'  # Name of the csv file the dataframe of tweets will be written to.
